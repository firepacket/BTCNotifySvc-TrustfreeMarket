...
namespace BitCoinSharp
{
    ...
    public class Script
    {
        ...
        private void Parse(byte[] programBytes, int offset, int length)
        {
            ...
            while (_cursor < offset + length)
            {
                ...
                else if (opcode == OpPushData4)
                {
                    ...
                    Console.Write("ERROR: " + "PUSHDATA4: Unimplemented");
                }
                else
                {
        ...
        public byte[] PubKeyHash
        {
            get
            {
                if (_chunks.Count != 5) // cant see from address
                    return new byte[0];
                ...
                if (_chunks[0][0] != OpDup ||
                    ...
                    return new byte[0]; // cant see from address
        ...
        public byte[] PubKey
        {
            get
            {
                ...
                if (_chunks.Count != 2)
                    return new byte[0]; // can't see from address
